...
const SelectDropdown = ({ label, list, name, value, required = false, handlerOnChange }) => {
  ...
  return (
    <div className={styles.formControl}>
      ...
      <select className={`${styles.select} ${inputFieldError ? styles.error : ''} `} name={name} value={value} onChange={onValidateInput} onBlur={blurHandler}>
        {optionsToDisplay}
      </select>
